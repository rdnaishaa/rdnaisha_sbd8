...
function Subjects({ searchQuery, setSearchQuery }) {
    ...
    return (
        <section id="subjects" className="py-16 relative bg-gray-100 dark:bg-gray-800 overflow-hidden">
            {/* Dynamic background */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute w-full h-full bg-gradient-to-br from-pink-100/30 to-transparent dark:from-pink-900/10 dark:to-transparent"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col items-center mb-14">
                    ...
                    <p className="text-lg text-center text-gray-600 dark:text-gray-400 max-w-2xl mt-4">
                ...
                <div className="flex justify-center mb-12">
                    <div className="bg-white dark:bg-gray-700 rounded-full shadow-lg p-1 flex flex-wrap justify-center">
                        <button
                ...
                {filteredSubjects.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-gray-700 rounded-2xl shadow-xl">
                    ...
                    <div className="relative">
                        {filteredSubjects.length > 1 && (
                            <>
                                ...
                                <button 
                                    onClick={scrollLeft}
                                    className="absolute left-0 top-1/2 transform -translate-y-1/2 md:-translate-x-2 z-20 bg-white dark:bg-gray-700 p-2 rounded-full shadow-lg hover:bg-pink-100 dark:hover:bg-gray-600 transition-all"
                                ...
                                <button 
                                    onClick={scrollRight}
                                    className="absolute right-0 top-1/2 transform -translate-y-1/2 md:translate-x-2 z-20 bg-white dark:bg-gray-700 p-2 rounded-full shadow-lg hover:bg-pink-100 dark:hover:bg-gray-600 transition-all"
                        ...
                        >
                            <div className="flex space-x-4 px-4 md:px-0 w-full">
                                {filteredSubjects.map((subject) => (
                                    ...
                                    >
                                        <div 
                                            className="h-full bg-white dark:bg-gray-700 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-pink-300/20 group"
                                            style={{ borderTop: '4px solid #EC4899' }}
                                        >
                                            <div className="p-6">
                                                <div className="flex items-center mb-4">
                                                    <div className="p-3 bg-pink-50 dark:bg-pink-900/30 rounded-full">
                                                        {subject.icon}
                                                    </div>
                                                ...
                                                <div className="mt-6 flex justify-between">
                                                    <button
                                                        ...
                                                        className="px-4 py-2 bg-pink-100 dark:bg-pink-900/30 text-pink-500 rounded-lg font-medium text-sm transition-colors hover:bg-pink-200 dark:hover:bg-pink-900/50"
                                                    >
                                            ...
                                            {activeSubject === subject.id && (
                                                <div className="px-6 pb-6 max-h-64 overflow-y-auto custom-scrollbar bg-pink-50/50 dark:bg-gray-800/50">
            ...
            {/* Modified Detail Modal - removed X button and updated colors */}
            {isModalOpen && selectedSubject && (
                <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 animate-fadeIn">
                    <div 
                        ref={modalRef}
                        className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl animate-scaleIn"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="relative h-48 bg-white dark:bg-gray-700 flex items-center justify-center">
                            {/* Removed the X button */}
                            
                            {/* Decorative Elements - updated to match the rest of the design */}
                            <div className="absolute inset-0 overflow-hidden">
                                <div className="bg-pink-50 dark:bg-gray-800 h-full w-full">
                                    <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-pink-100/20 to-transparent dark:from-pink-900/10"></div>
                                </div>
                            </div>
                            
                            <div className="text-center z-10">
                                <div className="bg-pink-50/70 dark:bg-pink-900/20 p-5 rounded-full inline-block mb-3 shadow-lg">
                                    <div className="transform scale-150">
                                        {selectedSubject.icon}
                                    </div>
                                </div>
                                <h3 className="text-pink-500 dark:text-pink-400 text-3xl font-bold">
                        ...
                        <div className="p-6 overflow-y-auto custom-scrollbar" style={{ maxHeight: 'calc(90vh - 48px - 56px)' }}>
                            {/* Overview Tab */}
                            {activeTab === 'overview' && (
                                <div className="space-y-6 animate-fadeIn overflow-y-auto max-h-96 custom-scrollbar">
                                    <div>
                                    ...
                                    <div className="bg-pink-50/50 dark:bg-gray-700/50 rounded-xl p-5">
                                    ...
                                    <div className="flex justify-center">
                                        <div className="flex items-center bg-pink-50 dark:bg-gray-700/50 px-5 py-3 rounded-full">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium text-gray-800 dark:text-gray-200">{selectedSubject.instructor}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Modules Tab */}
                            {activeTab === 'modules' && (
                                <div className="animate-fadeIn overflow-y-auto max-h-96 custom-scrollbar">
                                    <h4 className="text-xl font-semibold text-pink-500 mb-4">Course Modules</h4>
                                    <div className="bg-pink-50/50 dark:bg-gray-700/50 rounded-xl p-5">
                                        <ul className="space-y-4">
                                            {selectedSubject.materials.map((item, index) => (
                                                <li key={index} className="flex items-start">
                                                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-pink-500 text-white flex items-center justify-center mr-4 shadow-md shadow-pink-200 dark:shadow-pink-900/20">
                                                        {index + 1}
                                                    </div>
                                                    <div className="pt-1">
                            ...
                            {activeTab === 'info' && (
                                <div className="animate-fadeIn overflow-y-auto max-h-96 custom-scrollbar">
                                    <div className="relative mb-6">
                                        <div className="absolute top-0 left-0 w-16 h-16 bg-pink-100 dark:bg-pink-900/30 rounded-lg -z-10 transform -translate-x-2 -translate-y-2"></div>
                                        <div className="relative bg-white dark:bg-gray-700 p-5 rounded-lg shadow-md border border-pink-100 dark:border-gray-600">
                                    ...
                                    <div className="bg-pink-50/50 dark:bg-gray-700/50 rounded-xl p-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            {selectedSubject.materials.slice(0, 6).map((item, index) => {
                                                ...
                                                return (
                                                    <div key={index} className="flex items-center bg-white dark:bg-gray-800/60 p-3 rounded-lg">
                                                        <div className="w-2 h-2 bg-pink-500 rounded-full mr-3"></div>
                                                        <span className="text-gray-700 dark:text-gray-300 text-sm">{moduleName}</span>
                                                    </div>
                                                );
                                            })}
                                        </div>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 flex justify-center">
                            <button
